...
try:
    with open('trained_models_beta.pkl', 'rb') as file:
...
for name in datasets:
    ...
    for (at, ll) in transforms:
        ...
        G_train = wsigkernel.sig_kernel_matrix_beta_unsym(x_train, x_train, n=0, solver=0, theta=1., m=1., N_xp=21, sym=True)
        ...
        # save trained models
        with open('trained_models_beta.pkl', 'wb') as file:
        ...
        try:
            with open('final_results_beta.pkl', 'rb') as file:
        ...
        G_test = wsigkernel.sig_kernel_matrix_beta_unsym(x_test, x_train, n=0, solver=0, theta=1., m=1., N_xp=21, sym=False)
        ...
        # save results
        with open('final_results_beta.pkl', 'wb') as file:
