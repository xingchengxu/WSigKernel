# From https://github.com/crispitagorico/sigkernel/blob/master/sigkernel/transformers.py
import numpy as np
import copy
import math
...
# =============================================================================================
# Truncated signature kernel from Kiraly and Oberhauser
# =============================================================================================
...
def truncated_sig_kernel(X, Y, num_levels, sigma=1., order=-1):
    ...
    M = np.reshape(X.reshape((-1, num_feat)) @ Y.reshape((-1, num_feat)).T,
                   (num_seq_X, len_seq_X, num_seq_Y, len_seq_Y))
